...
<div>
    ...
    <span><input type="text" name="prenom_usager" id="prenom_usager" value="{{$usager->prenom}}"></span>
</div>
<div>
    <label for="nom">Nom usager</label>
    <span><input type="text" name="nom_usager" id="nom_usager" value="{{$usager->nom}}"></span>
</div>
<div>
    <label for="adresse_civique">Adresse</label>
    <span><input type="text" name="adresse_civique" id="adresse_civique" value="{{$usager->code_postal}}"></span>
</div>
<div>
    <label for="ville">Ville</label>
    <span><input type="text" name="ville_usager" id="ville_usager" value="{{$usager->ville}}"></span>
</div>
<div>
